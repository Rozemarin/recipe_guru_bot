...
RECIPE_NAME, RECIPE_DESCRIPTION = range(2)
...
def main() -> None:     
    ...
    conv_handler_add = ConversationHandler(
        ...
        states={
            ...
            RECIPE_DESCRIPTION: [MessageHandler(filters.TEXT & ~filters.COMMAND, recipe_description)],
        },
    ...
    conv_handler_edit = ConversationHandler(
        ...
        states={
            RECIPE_NAME: [MessageHandler(filters.TEXT & ~filters.COMMAND, edit_recipe_name)],
            RECIPE_DESCRIPTION: [MessageHandler(filters.TEXT & ~filters.COMMAND, edit_recipe_description)],
        },
        fallbacks=[CommandHandler("cancel", cancel)],
    )
    ...
    conv_handler_delete = ConversationHandler(
        ...
        states={
            RECIPE_NAME: [MessageHandler(filters.TEXT & ~filters.COMMAND, delete_recipe_name)],
        },
        fallbacks=[CommandHandler("cancel", cancel)],
    )
